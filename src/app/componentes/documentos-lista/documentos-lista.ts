...
import { DocumentosService } from '../../core/servicios/documentos/documentos';
import { Documento } from '../../core/modelos/documento.model';
...
export class DocumentosLista implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    // Solo cargar automáticamente si ya tenemos el ID o si es nuestro perfil
    if (this.usuarioId !== undefined || !this.soloLectura) {
